  ...
  return (
    ...
    <div className="!w-[267px]">
      <Sidebar className={props.className}>
        ...
        <div className="flex flex-col items-center justify-start md:ml-[0] ml-[62px] mr-[71px] mt-[23px] w-[49%]">
          <Img
        ...
        <div className="flex flex-col items-center justify-start mb-[406px] mt-6 w-full">
        <div className="h-[60px] relative w-full">
            ...
            <div className="absolute h-[60px] inset-[0] justify-center m-auto w-full">
              <div className="flex flex-row gap-[11px] h-full items-center justify-center ml-[17px] my-auto w-[53%]">
                <div className="bg-gray-900_01 h-9 rounded-[50%] w-9 ml-2"></div>
                <Text
          ...
          {/* images/img_sort.svg */}
          <div className="h-[60px] relative w-full">
            <div className="bg-indigo-50 h-[37px] ml-auto mr-[21px] my-auto rounded-br-[20px] rounded-tr-[20px] rounded-tl-[20px] rounded-bl-[20px] w-[84%] mt-[11.4px]"></div>
            <div className="absolute h-[60px] inset-[0] justify-center m-auto w-full">
              <div className="flex flex-row gap-[11px] h-full items-center justify-start ml-[27px] my-auto w-[66%]">
                <div className="bg-indigo-50 h-9.2 rounded-[50%] w-9"></div>
                <Text
          ...
          <div className="h-[60px] relative w-full mr-[38px]">
            <div className="bg-gray-900 h-[37px] ml-auto mr-[21px] my-auto rounded-br-[20px] rounded-tr-[20px] w-[74%]"></div>
