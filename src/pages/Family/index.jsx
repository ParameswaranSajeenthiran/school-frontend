    ...
    <>
      <div className="bg-indigo-50 flex flex-col font-alfaslabone items-center justify-end mx-auto w-full">
        ...
        <Sidebar1 className="!sticky !w-[267px] bg-gray-900 flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0]" />
          <div className="flex md:flex-1 flex-col font-ibmplexsans gap-[23px] items-center justify-start md:px-5 w-[86%] md:w-full">
            ...
            <div className="bg-gray-100 flex flex-col items-center justify-start p-7 sm:px-5 rounded-[20px] w-[97%] md:w-full">
              <div className="flex flex-col gap-[39px] items-start justify-start mb-44 w-[98%] md:w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <div className="flex flex-row items-center justify-between mt-[63px] w-[41.6%] md:w-full">
                  ...
                  >
                    ...
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <div className="flex flex-col gap-2 items-start justify-start md:ml-[0] ml-[516px]">
                        <Text
                          className="text-gray-800 text-sm"
                          size="txtInterRegular14Gray800"
                        >
                      ...
                      <div className="flex flex-col gap-2 items-start justify-start md:ml-[0] ml-[470px]">
                        <Text
                          className="text-gray-800 text-sm"
                          size="txtInterRegular14Gray800"
                        >
                  ...
                  <div className="flex flex-row items-center justify-between mt-[38px] w-[43%] md:w-full">
                    ...
                    <div className="flex flex-col gap-[9px] items-start justify-start">
                      <Text
                        className="text-gray-800 text-sm mr-[17px]"
                        size="txtInterRegular14Gray800"
                      >
                ...
                <div className="flex flex-col gap-2 items-start justify-start">
                  ...
                  >
                    <>
                      If you are unable to mention mother&#39;s NIC no mention
                      the reason
                    </>
                  </Text>
                  <Text
